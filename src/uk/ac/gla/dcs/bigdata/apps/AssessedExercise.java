...
import uk.ac.gla.dcs.bigdata.studentfunctions.map.NewsArticleToCleanArticleMap;
...
public class AssessedExercise {
	...
	public static List<DocumentRanking> rankDocuments(SparkSession spark, String queryFile, String newsFile) {
		...
		Dataset<CleanArticle> cleanNews = news.map(new NewsArticleToCleanArticleMap(), Encoders.bean(CleanArticle.class));
